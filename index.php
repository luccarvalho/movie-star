...
<div id="main-container" class="container-fluid">
    ...
    <div class="movies-container">
        ...
        <?php if(count($latestMovies) === 0) : ?>
            <p class="empty-list">Ainda não existem filmes cadastrados!</p>
        <?php endif; ?>
    </div>
    ...
    <div class="movies-container">
        ...
        <?php if(count($actionMovies) === 0) : ?>
            <p class="empty-list">Ainda não existem filmes de ação cadastrados!</p>
        <?php endif; ?>
    </div>
    ...
    <div class="movies-container">
        ...
        <?php if(count($comedyMovies) === 0) : ?>
            <p class="empty-list">Ainda não existem filmes de comédia cadastrados!</p>
        <?php endif; ?>
    </div>
</div>
