<?php
    ...
    if(!empty($userData)) {
        ...
        // Confere se já existe reviews do usuário
    ...
    <div class="row">
        ...
        <div class="offset-md-1 col-md-10" id="reviews-container">
            ...
            <div class="col-md-12" id="review-form-container">
                ...
                <p class="page-description">Preencha o formulário com a nota e comentário sobre o filme ou série</p>
            ...
            <?php if(count($movieReviews) == 0): ?>
                <p class="empty-list">Ainda não foram feitos comentários para este filme...</p>
            <?php endif; ?>     
        </div>
    </div>
</div>
